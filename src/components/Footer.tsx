  ...
  return (
    <div className="bg-black pt-24 pb-20 max-sm:pt-10">
      <div className="container mx-auto px-5">
        ...
        <div className="mt-12 pt-5 pl-5 flex justify-between border-t border-white text-white font-poppins text-left max-sm:flex-col max-sm:pl-0">
          <div className="flex gap-14">
            <div>
              ...
              <div className="mt-6 flex flex-col gap-6">
                ...
                <div className="flex gap-6 max-w-[330px] max-sm:flex-col max-sm:items-start">
          ...
          <div className="flex gap-14 max-sm:mt-7 max-sm:justify-between">
            <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col max-w-[300px] max-sm:mt-12 max-sm:max-w-full">
            <div className="p-3 pb-5 bg-footerSubBox rounded-lg">
              <div className="font-semibold text-lg max-sm:mt-">
                Join Our Newsletter
              </div>
